      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {agents.map((agent, idx) => (
            <div key={idx} className="p-10 bg-stone-50 rounded border border-stone-100 flex flex-col items-start hover:bg-white hover:border-muted-gold hover:scale-[1.02] hover:shadow-xl transition-all duration-300 ease-out group">
